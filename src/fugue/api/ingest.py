"""src/fugue/api/ingest.py — IngestPipeline 端到端摄取流水线。"""
...
import fugue.handlers.chunkers  # noqa: F401  — 触发 chunker_registry 注册副作用
import fugue.handlers.parsers  # noqa: F401  — 触发 parser_registry 注册副作用
from fugue.api.types import IngestResult, ParsedDocument
from fugue.config import FugueConfig
...
from fugue.registry import chunker_registry, parser_registry
