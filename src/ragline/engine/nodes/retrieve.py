"""src/ragline/engine/nodes/retrieve.py — 单个检索任务节点（best-effort）。"""

import logging
from typing import Any

from ragline.engine.state import RetrieveInput
from ragline.registry import retriever_registry

logger = logging.getLogger("ragline.engine.nodes.retrieve")
