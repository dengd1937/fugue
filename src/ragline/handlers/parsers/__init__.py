"""src/ragline/handlers/parsers/__init__.py — 注册 + auto 分派。"""

from pathlib import Path

from ragline.api.types import ParsedDocument
from ragline.handlers.parsers.markdown_text import markdown_parser, text_parser
from ragline.handlers.parsers.pdf import pdf_parser
from ragline.registry import parser_registry  # noqa: E402
